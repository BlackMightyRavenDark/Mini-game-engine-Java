...
public class Keyboard {
    ...
    public static final int KEY_BACKSPACE = GLFW_KEY_SPACE;
    ...
    public static final int KEY_MOD_SHIFT = GLFW_MOD_SHIFT;
    public static final int KEY_MOD_CONTROL = GLFW_MOD_CONTROL;
    public static final int KEY_MOD_ALT = GLFW_MOD_ALT;
    public static final int KEY_MOD_SUPER = GLFW_MOD_SUPER;
    public static final int KEY_MOD_CAPS_LOCK = GLFW_MOD_CAPS_LOCK;
    public static final int KEY_MOD_NUM_LOCK = GLFW_MOD_NUM_LOCK;

    public static final int EVENT_PRESS = GLFW_PRESS;
    public static final int EVENT_RELEASE = GLFW_RELEASE;
    public static final int EVENT_REPEAT = GLFW_REPEAT;

    public static boolean hasEvent = false;
    public static int eventKey;
    public static int eventScancode;
    public static int eventAction;
    public static int eventMods;
    public static long windowId = 0;

    public static boolean nextEvent() {
        if (hasEvent && Keyboard.windowId != 0) {
            hasEvent = false;
            return true;
        }
        hasEvent = false;
    ...
    public static boolean isKeyDown(int key) {
        return Keyboard.windowId != 0 && key != GLFW_KEY_UNKNOWN && (glfwGetKey(windowId, key) == Keyboard.EVENT_PRESS);
    }
}
